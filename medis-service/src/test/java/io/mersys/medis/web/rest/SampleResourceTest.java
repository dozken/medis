...
import io.mersys.medis.service.SampleService;
import io.mersys.medis.service.dto.SampleDTO;
import io.mersys.medis.service.dto.SampleSearchDTO;
import io.mersys.medis.service.mapper.SampleMapper;
...
public class SampleResourceTest {
	...
	public void search() throws Exception {
		...
		perform.andExpect(status().isOk()).andExpect(content().contentType(TestUtil.API_VERSION1_JSON_UTF8))
				...
				.andExpect(jsonPath("$.[*].shortName").value(hasItem("" + document.getShortName())));
	}
	...
	public void create() throws Exception {
		...
		perform.andExpect(status().isCreated()).andExpect(content().contentType(TestUtil.API_VERSION1_JSON_UTF8))
				...
				.andExpect(jsonPath("$.type").value("" + SampleType.TYPE1))
